$(function () {
    ...
    if (mb.matches) {
        ...
        controlmap.src="../src/img/layout/control-map.png";
        alltheme[0].src="../src/img/layout/all-theme.png";
        map_wood.src="../src/img/layout/wood-theme.png";
        map_fire.src="../src/img/layout/fire-theme.png";
        map_gold.src="../src/img/layout/gold-theme.png";
        map_water.src="../src/img/layout/water-theme.png";
        map_terra.src="../src/img/layout/terra-theme.png";
        ...
        controlmap.src="../src/img/layout/control-map_phone370.png";
        alltheme[0].src="../src/img/layout/all-theme_phone370.png";
        map_wood.src="../src/img/layout/wood-theme_phone370.png";
        map_fire.src="../src/img/layout/fire-theme_phone370.png";
        map_gold.src="../src/img/layout/gold-theme_phone370.png";
        map_water.src="../src/img/layout/water-theme_phone370.png";
        map_terra.src="../src/img/layout/terra-theme_phone370.png";
        ...
        controlmap.src="../src/img/layout/control-map_phone270.png";
        alltheme[0].src="../src/img/layout/all-theme_phone270.png";
        map_wood.src="../src/img/layout/wood-theme_phone270.png";
        map_fire.src="../src/img/layout/fire-theme_phone270.png";
        map_gold.src="../src/img/layout/gold-theme_phone270.png";
        map_water.src="../src/img/layout/water-theme_phone270.png";
        map_terra.src="../src/img/layout/terra-theme_phone270.png";
